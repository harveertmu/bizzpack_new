                ...
                <div class="card mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input onkeydown="return /[a-z]/i.test(event.key)" class="form-control form-control-solid @error('name') is-invalid @enderror" id="name" name="name" type="text" placeholder="" value="{{ old('name') }}" />
                            @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-solid @error('type') is-invalid @enderror" id="type" name="type">
                                    ...
                                    @foreach($supplierTypes as $supplier)
                                        <option @if(old('type') == $supplier->id )selected="selected"@endif value="{{ $supplier->id }}">{{ $supplier->name }}</option>
                                    @endforeach
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input onkeydown="return /[a-z]/i.test(event.key)" class="form-control form-control-solid @error('account_holder') is-invalid @enderror" id="account_holder" name="account_holder" type="text" placeholder="" value="{{ old('account_holder') }}" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input onkeypress="return isNumberKey(event);" class="form-control form-control-solid @error('account_number') is-invalid @enderror" id="account_number" name="account_number" type="text" placeholder="" value="{{ old('account_number') }}" />
