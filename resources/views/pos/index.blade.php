                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pos.createInvoice') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <label class="small mb-1" for="vehicle_number">Vehicle Number <span class="text-danger">*</span></label>
                                <input class="form-control form-control-solid @error('vehicle_number') is-invalid @enderror" id="vehicle_number" name="vehicle_number" type="text" placeholder="" value="{{ old('vehicle_number') }}" autocomplete="off" />
                            ...
                            <table class="table table-striped align-middle">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">@sortablelink('name', 'Vandor Name')</th>
                                        <th scope="col">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> {{$product->vendorDetails['name'] }} </td>
                                        
                                        <td>
                                            <div class="d-flex">
                                            <!-- <a href="{{ route('pos.edit', $product->id) }}" class="btn btn-outline-primary btn-sm mx-1"> <i class="fa-solid fa-plus"></i></a> -->
