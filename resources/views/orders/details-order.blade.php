                ...
                <div class="card-body">
                    ...
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-control form-control-solid">{{ $order->customer->phone_number }}</div>
                        </div>
                    ...
                    <div class="mb-3">
                     ...
                     <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('zip') is-invalid @enderror" id="zip" name="zip" type="text" placeholder="" value="{{ old('zip',$order->customer->zip) }}" />
                                @error('zip')
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('city') is-invalid @enderror" id="city" name="city" type="text" placeholder="" value="{{ old('city',$order->customer->city) }}" />
                                @error('city')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <!-- Form Group (address) -->
                         ...
                         <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('state') is-invalid @enderror" id="state" name="state" type="text" placeholder="" value="{{ old('state',$order->customer->state) }}" />
                                @error('state')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('street_address*') is-invalid @enderror" id="street_address*" name="street_address" type="text" placeholder="" value="{{ old('street_address*',$order->customer->street_address) }}" />
