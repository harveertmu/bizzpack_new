                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <form action="{{ route('order.downloadFile') }}" method="POST">
                                                @method('post')
                                                @csrf
                                                <input type="hidden" name="challan_name" value="{{$order->challan_name}}">
                                                <!-- Submit button -->
                                                <button type="submit" class=" btn-success"><i class="fa fa-download"></i></i></button>
