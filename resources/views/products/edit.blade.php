            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        <!-- Product image -->
                        <img class="img-account-profile mb-2" src="{{ $product->product_image ? asset('product_image/'.$product->product_image) : asset('assets/img/products/default.webp') }}" alt="" id="image-preview" />
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-6">
                                    <label class="small mb-1" for="bank_name">Product Code</label>
                                    <select class="form-select form-control-solid @error('product_code') is-invalid @enderror" id="product_code" name="product_code">
                                        <option selected="" disabled="">Select a product code:</option>
                                        @foreach($productcodes as $product_code)
                                            <option @if(old('product_code', $product->product_code) == $product_code->id )selected="selected"@endif value="{{ $product_code->id }}">{{ $product_code->product_code }}</option>
                                        @endforeach
                        ...
                        <!-- Form Group (stock) -->
                        <div class="mb-3">
                            <label class="small mb-1" for="stock">Quantity <span class="text-danger">*</span></label>
