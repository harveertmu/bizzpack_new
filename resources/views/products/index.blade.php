                        ...
                        <table class="table table-striped align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$product['productCode']->product_code }}</td>
                                    <td>
                                        <div style="max-height: 80px; max-width: 80px;">
                                            <img class="img-fluid"  src="{{ $product->product_image ? asset('product_image/'.$product->product_image) : asset('assets/img/products/default.webp') }}">
                                        </div>
                                    </td>
