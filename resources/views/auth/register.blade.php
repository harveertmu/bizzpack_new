            ...
            <div class="card my-5">
                ...
                <div class="card-body p-5">
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="text-gray-600 small" for="role">Customer</label>
                            <input class="form-check-input" type="radio" id="role" name="role" placeholder="" value="customer" autocomplete="off" checked/>
                            <label class="text-gray-600 small" for="role">Vendor</label>
                            <input class="form-check-input " type="radio" id="role" name="role" placeholder="" value="vendor" autocomplete="off"/>
